...
axes(handles.axes1);
imshow(image1);
set(handles.edit1,'String',num2str(size(image1,1)));
set(handles.edit2,'String',num2str(size(image1,2)));
global image2;
global labelImg;
global getObj;
% image2=imread('puma2.jpg');
% axes(handles.axes2);
% imshow(image2);
...
cols = str2double(get(handles.edit2,'String'));
mediann=Median(image1,rows,cols);
imshow(mediann,'Parent', handles.axes2);
...
rows = str2double(get(handles.edit1,'String'));
cols = str2double(get(handles.edit2,'String'));
av=Averaging(image1,rows,cols);
imshow(av,'Parent', handles.axes2);
...
rows = str2double(get(handles.edit1,'String'));
cols = str2double(get(handles.edit2,'String'));
decim=Decimation(image1,rows,cols,0);
imshow(decim,'Parent', handles.axes2);
...
rows = str2double(get(handles.edit1,'String'));
cols = str2double(get(handles.edit2,'String'));
decim=Decimation(image1,rows,cols,1);
imshow(decim,'Parent', handles.axes2);
...
addpath('./Canny');
cann=Prewitt(image1);
imshow(cann,'Parent', handles.axes2);
...
global image1;
% image1=imread('puma.jpg');
%thresh = str2double(get(handles.edit8,'String'));
[newThresh,outp]=OTSU2(image1);
imshow(outp,'Parent', handles.axes2);
set(handles.edit8,'String',num2str(newThresh));
...
% image1=imread('puma.jpg');
addpath('./Labelling');
[labelImg,count]=Labelling(image1);
set(handles.edit3,'String',num2str(count-1));
imshow(labelImg,'Parent', handles.axes1);
...
% image1=imread('puma.jpg');
addpath('./Labelling');
obj = str2double(get(handles.edit4,'String'));
getObj=GetObject(labelImg,obj);
imshow(getObj,'Parent', handles.axes2);
...
addpath('./Labelling');
%obj = str2double(get(handles.edit4,'String'));
area=FindArea(getObj);
set(handles.edit5,'String',num2str(area));
% getObj=GetObject(labelImg,obj);
% imshow(getObj,'Parent', handles.axes2);
...
addpath('./Labelling');
%obj = str2double(get(handles.edit4,'String'));
[r,c]=Centeroid_Points(getObj);
set(handles.edit6,'String',num2str(r));
